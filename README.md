...
```
{
  "repositories": [
    {
      "type": "git",
      "url": "https://github.com/urlslab-php-client/urlslab.git"
    }
  ],
  "require": {
    "urlslab-php-client/urlslab": "*@dev"
  }
}
```
...
*ApikeyApi* | [**validation**](docs/Api/ApikeyApi.md#validation) | **GET** /v1/apikey/validate | validate a given API Key
